      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Bookings</a><a class="item " href="transactions.php">Transacciones</a><a class="active item" href="travelclass.php">Traveling Classes</a><a class="item">Export</a>
