...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>Arequipa a Lima</option>
      <option>Lima a Arequipa</option>
	   <option>Arequipa a Madre de Dios</option>
	    <option>Madre de Dios a Arequipa</option>
    </select>
  </div>   
  </div>
<div class="field">  
 ...
 <div class="field">
    <select name="gender" required id="travelclass">
      ...
      <option>Clase Premium</option>
      <option>Vlase Media</option>
	   <option>Clase Económica</option>
	    <option>Clase Especial</option>
    </select>
  </div>   
  </div>
...
<form class="ui form attached fluid loading segment" onsubmit="return billing(this)">
 ...
 <div class="field">
    <select name="gender" required id="gender">
      <option value="" selected disabled>--Choose Genero--</option>
...
<div class="ui icon input">
  ...
  <div class="field"> 
<label>Confirmacion Monto</label>

<div class="ui icon input">
  <input value="52.03" type="text" id="amount" readonly>
</div></div>
 <div style="text-align:center">
  <button class="ui green submit button">Procesar</button>
</div>
 </form>
